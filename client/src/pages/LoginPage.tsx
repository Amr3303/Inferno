    ...
    try {
      ...
      try {
        if (
          ...
          console.warn(
            "localStorage is not available or token/user structure in response is unexpected."
          );
          toast({
            title: "Warning",
            description:
              "Local storage is not available or login information structure is incorrect.",
          });
        }
  ...
  return (
    <AuthLayout title="Login">
      <form onSubmit={handleLogin} className="w-full max-w-md">
        ...
        <button
          type="submit"
          className={`w-full py-3 px-6 bg-broadcast-blue text-white rounded-md mt-4 transition-opacity duration-300 ${
