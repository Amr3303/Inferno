...
// Mock agents data
const mockAgents = [
  { id: 1, name: "Abdelrahman Shokry", email: "AbdelrahmanShokry@example.com", status: "Active" },
  { id: 2, name: "Amr Khaled", email: "AmrKhaled@example.com", status: "Active" },
  { id: 3, name: "Ahmed Antar", email: "AhmedAntar@example.com", status: "Active" },
  { id: 4, name: " Hazem Gamal", email: " HazemGamal@example.com", status: "Active" },
  { id: 5, name: " Sara Ali", email: " SaraAli@example.com", status: "Active" }
];
                    ...
                    case "text":
                      return (
                        typeof msg.content === 'string' && (
                          <MessageCard key={index} content={msg.content} onOptionsClick={() => {}} />
                        )
                      );
                    case "location":
                      return (
                        typeof msg.content === 'string' && (
                          <LocationCard key={index} content={msg.content}  coordinates={{ lat: msg.coordinates.lat, lng: msg.coordinates.lng }} onOptionsClick={() => { }} />
                        )
                      );
                    case "progress":
                      return (
                        typeof msg.content === 'string' && (
                          <ProgressCard key={index} content={msg.content}  progress={msg.progress} />
                        )
                      );
                    case "query":
                      return (
                        typeof msg.content !== 'string' && (
                          <QueryCard key={index} content={msg.content} onOptionsClick={() => {}} />
                        )
                      );
                    default:
                      return null;
