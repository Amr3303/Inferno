...
export const MessagesPage: FC = () => {
  ...
  useEffect(() => {
    ...
    // Fetch all message types
    fetchMessages(selectedBroadcastId, token);
    fetchTextMessages(selectedBroadcastId, token);
    fetchLocationMessages(selectedBroadcastId, token);
    fetchProcessMessages(selectedBroadcastId, token);
    fetchQueryMessages(selectedBroadcastId, token);
